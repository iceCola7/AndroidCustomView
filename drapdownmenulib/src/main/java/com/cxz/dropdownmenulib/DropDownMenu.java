package com.cxz.dropdownmenulib;
...
public class DropDownMenu extends LinearLayout {
    ...
    private View getDividerView() {
        ...
        double height = dividerHeight > 0 ? dpToPx(dividerHeight) : dividerHeight;
        LayoutParams params = new LayoutParams(dpToPx(0.5f), (int) height);
