package com.cxz.camerasample.glsurfaceview;
...
import com.cxz.camerasample.ImageUtils;
import com.cxz.camerasample.R;
import com.cxz.camerasample.camera.Camera2Proxy;
...
public class GLSurfaceCamera2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.toolbar_close_iv) {
            finish();
        } else if (id == R.id.toolbar_switch_iv) {
