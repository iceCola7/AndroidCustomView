 ...
 */
public class LoadingLoadView extends View {
    ...
    public LoadingLoadView(Context context) {
        this(context, null);
    }

    public LoadingLoadView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingLoadView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LoadingLoadView);
        mOuterCircleRadius = typedArray.getDimensionPixelSize(R.styleable.LoadingLoadView_outerCircleRadius, 50);
        mOuterCircleColor = typedArray.getColor(R.styleable.LoadingLoadView_outerCircleColor, 0xFF228B22);
        mInnerTriangleRadius = typedArray.getDimensionPixelSize(R.styleable.LoadingLoadView_innerTriangleRadius, 25);
        mInnerTriangleColor = typedArray.getColor(R.styleable.LoadingLoadView_innerTriangleColor, 0xFF228B22);
        mIsNeedBackground = typedArray.getBoolean(R.styleable.LoadingLoadView_isNeedBackground, true);
        mBackgroundColor = typedArray.getColor(R.styleable.LoadingLoadView_backgroundColor, 0xBB222222);
        mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.LoadingLoadView_strokeWidth, 5);
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<LoadingLoadView> mLoadingViewWeakReference;

        private MyHandler(LoadingLoadView loadingView) {
